...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "calc(100vh - 68px)", background: "var(--bg)" }}>
      <AdminMobileNav />

      <div style={{ display: "flex", flex: 1 }}>
        {/* Sidebar — desktop only */}
        <aside className="admin-sidebar" style={{ width: 240, background: "var(--bg-card)", borderRight: "1px solid var(--border)", padding: "24px 12px", flexDirection: "column", gap: 4, flexShrink: 0 }}>
